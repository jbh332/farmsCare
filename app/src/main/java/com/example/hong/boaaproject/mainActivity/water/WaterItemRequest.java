...
public class WaterItemRequest extends StringRequest {


    final static private String URL = "http://jbh9730.cafe24.com/ItemUpload.php";
    private Map<String, String> parameters;

    public WaterItemRequest(String itemCode, String itemURL, String userID, Response.Listener<String> listener) {
